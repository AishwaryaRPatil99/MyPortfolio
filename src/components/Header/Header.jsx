...
import Aishwarya from "../../assets/Images/jpeg/protfolio-icon.png";
import { Link } from "react-router-dom";
import { Link as ScrollLink, animateScroll as scroll } from "react-scroll";
import ResumePdf from "../../assets/pdfs/Aishwarya-FDE.pdf";
    ...
    <>
      <div className="header-div">
        <div className="header-brand-div">
          <img src={Aishwarya} alt="aishwarya" className="renu-hp-img" />
